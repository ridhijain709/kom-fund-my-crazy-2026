...
```mermaid
graph LR
    P1["01 | The Shortlist<br/>(16–17 Sept)<br/>✅ QUALIFIED"] --> P2["02 | Build in Public<br/>(18–21 Sept)<br/>🚀 ACTIVE NOW"]
    P2 --> P3["03 | The Top 10<br/>(25 Sept)<br/>Target: IIT Delhi Stage"]
    P3 --> P4["04 | The Finale<br/>(1 Oct @ IIT Delhi)<br/>🏆 ₹1 Crore Prize Pool"]
```
...
![KOM Node Architectural Cutaway](KOM_Node_Poster.png)
...
```mermaid
graph TD
    A["Commuter Voice Input (Mobile / Node)"] --> B["Step 1: Acoustic FFT & Entropy Filter"]
    B -->|Passed: Natural Voice & SNR > 20dB| C["Step 2: Sanitizer Agent Shield"]
    B -->|Failed: Replay / Deepfake Audio| X1["QUARANTINE: Spoofing Flagged"]
    C -->|Passed: Zero Injection Syntax| D["Step 3: Deterministic Evaluator Engine"]
    C -->|Failed: Injection Patterns Detected| X2["QUARANTINE: Jailbreak Neutralized"]
    D --> E["Workday / Greenhouse Recruiter ATS Relay"]
```
...
![Slide 2 Preview](slides/exec_slide_2_4k.png)
...
![Slide 3 Preview](slides/exec_slide_3_4k.png)
...
![Slide 4 Preview](slides/exec_slide_4_4k.png)
...
![Slide 5 Preview](slides/exec_slide_5_4k.png)
